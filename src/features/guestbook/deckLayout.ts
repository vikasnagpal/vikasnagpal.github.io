...
export function slotLayout(p: number): CardLayout {
  if (p <= 0)
    return { tx: 0, ty: 0, rot: -1.2, sc: 1, z: 100, sh: '0 28px 58px rgba(122,56,24,0.36)', op: 1 }
  if (p === 1)
    return { tx: -12, ty: 15, rot: -4, sc: 0.965, z: 90, sh: '0 16px 34px rgba(96,58,26,0.26)', op: 1 }
  if (p === 2)
    return { tx: 12, ty: 15, rot: 5, sc: 0.93, z: 80, sh: '0 12px 26px rgba(132,86,38,0.24)', op: 1 }
  return { tx: 13, ty: 16, rot: 5, sc: 0.9, z: 80 - p, sh: '0 8px 18px rgba(132,86,38,0.14)', op: 0 }
}
